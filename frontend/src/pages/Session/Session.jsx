...
function Session() {
	...
	const [, setChunksSent] = useState(0);
	...
	async function startMicrophone() {
		...
		processor.onaudioprocess = (event) => {
			...
			if (speaking && !wasSpeakingRef.current) {
				// console.log(">>> LOCAL SPEECH START");
	...
	function playIncomingPCMChunk(arrayBuffer) {
		...
		playbackSourcesRef.current.push(bufferSource);
...
// 		// Keep track of this source so we can stop it during interruption
// 		playbackSourcesRef.current.push(bufferSource);
